import { UserClient } from '../../../2-core/domain/entities/movie/user-client';
...
import { IUserClientRepository } from '../../../2-core/application/movie/contracts/repositories/i-user-client-repository';
